...
%   Puts the data in the right configuration to use it in MCML_plot_conm     
                ...
                file_name = ['L_' char(L) '_NA_' char(NA) '_l_' char(l)]; 
                if h==1
                file_Frz = [fullfile(path,'MCML_Sim','Output',[file_name '.Frzc'])];   
                elseif h==2
                      file_Frz = [fullfile(path,'MCML_Sim','Output2',[file_name '.Frzc'])]; 
                elseif h==3
                      file_Frz = [fullfile(path,'MCML_Sim','Output3',[file_name '.Frzc'])]; 
                end
