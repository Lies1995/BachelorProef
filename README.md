...
De files voor fluence rate /licht intensiteit, enkel het bestand voor het lezen in matlab committen
Weensdag 14 oktober:

Hannelore: alle .Frzc files maken en committen. 
- [x] L_474_NA_0.12_d_9
- [x] L_474_NA_0.37_d_200
- [x] L_560_NA_0.12_d_9
...
- [x] code aanpassen om een contourplot te maken vor verschillende fluence rates DINSDAG Lies
...
Tegen Vrijdag 27/11
Hannelore
- [x] fout op psi vinden (en de contour plot)--> voor alle 4 de protocols
- [x] fout op tau (schrijf in Data)
Lies 
...
- [x] nadenken over fout op gepulste stimulatie

Tegen Dinsdag 01/12
Hannelore
- [ ] resultaten van gepulste stimulatie
