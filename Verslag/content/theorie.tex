...
Voor de derde aanname moeten de temperatuurstijging en lichtverdeling $0$ geworden zijn voor $z>z_0=2/(\mu_a +(1-g)\mu_s)$ en $r>r_0=w_L$. Aan deze voorwaarde is voldaan wanneer de thermische diffusielengte kleiner is dan $r_0$ en $z_0$. De thermische diffusielengte is gelijk aan $\sqrt{4\frac{k}{\rho c}t_{puls}}$. Voor $z_0$ levert dit geen problemen op. Voor $r_0$ echter betekend dit een sterke limitering op de pulstengte. Met behulp van tabel \ref{tab:thermEig} kan hieruit de maximale pulslengte berekend worden. Voor de single-mode is dat $2.6\cdot10^{-5}s$ en voor multi-mode $1.7\cdot10^{-2}s$. Aan de derde voorwaarde zal hierdoor niet altijd voldaan zijn, wat een fout op het model zal opleveren.
