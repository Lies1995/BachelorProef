...
Om de werking van het hersenen te begrijpen is een eerste grote en noodzakelijke stap het controleren van de activiteit van de hersencellen, \emph{neuronen}.  Neuronen zijn cellen die voordurend signalen ontvangen en versturenen door ons hele lichaam. Wanneer de activiteit geinhibeerd kan worden of een neuron gestimuleerd kan worden om signalen te sturen, kan de functie van die cel achterhaald worden. Bijvoorbeeld, tijdens een experiment, waarbij het proefdier moet onhouden waar een beloning ligt,worden enkele neuronen geinhibeerd. Als het proefdier achteraf niet meer weet waar de beloning lag, kan daaruit afgeleid worden dat deze cel verantwoordelijk is voor ruimtelijke ori\"en
