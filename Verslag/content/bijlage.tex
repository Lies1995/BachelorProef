...
Onderstaande matlabcode leest de .csv bestanden uit de map \emph{unitFR} en berekent de temperatuursverandering voor een continue stimulatie met behulp van vergelijking \ref{eq:solBH}. Vervolgens plot hij op drie tijdstippen (\emph{Times$\_$to$\_$plot}) de temperatuursverandering. Tot slot worden nog twee grafieken (voor SM en MM) gemaakt van $\DeltaT$ in functie van de tijd.\\
