...
\begin{figure}[tb]
  	\centering
  	\includegraphics[width=10cm]{gfx/dT_560_MM.png}
  	\caption{Caption here}
  	\label{fig:dT_560_MM}
  \end{figure} 
\\
...
\begin{tabular}{c||c|c}
& $\tau_{SM}$ [$10^{-2} ms$]& $\tau_{MM} [$10^{}ms$]$ \\ \hline
$474 nm$ & $2.5\pm 0.8$ & $1.2\pm 0.4$ \\
$560 nm$ & $2.5\pm 0.7$ & $1.2 \pm 0.4$ \\
\end{tabular}
\label{tab:tau}
\end{table}
...
\begin{figure}[tb]
  	\centering
  	\includegraphics[width=10cm]{gfx/4dT.png}
  	\caption{Caption here}
  	\label{fig:4dT}
  \end{figure} 
...
\hline
Irradiantie{[}mW/mm^2{]} & Puls lengte {[}ms{]} & Frequentie {[}Hz{]} & \multicolumn{2}{c}{Maximale $\Delta T$}{[}m^{\circ}C{]} \\
