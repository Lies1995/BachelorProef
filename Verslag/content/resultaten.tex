...
De eerste code werd gebruikt om de lichtverdeling $\phi(r,z)$ voor een bepaalde input power te bekomen. Hiervoor wordt vergelijking \ref{} gebruikt. Figuur \ref{fig:FR} geeft $\phi(r,z)$ weer voor een stimulatie van laserlicht met een power van $1mW$ en voor de vier verschillende protocols waarop gefocusd wordt in dit onderzoek. 
